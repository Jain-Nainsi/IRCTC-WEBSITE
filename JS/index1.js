    ...
    .then((data) => {
      ...
      if(localStorage.getItem("sl")=="1"){
        if(data.result.length>0){
          ...
          row.innerHTML=html;
          row.style.cssText="background-color:black,color:white";
          }
...
if (localStorage.getItem("sl") == "1") {
  ...
  log.appendChild(i);
  p.innerHTML = "Hi " + localStorage.getItem('user');
  p.style.cssText = "color:blue;margin-top:-10px;";
